...
metadata: 
  rules:
    - type: always
      description: "Check a documentation docs for a component before using it."
    - type: always
      description: "Check project context before advising on imports, presets, templates, or component usage. Use the injected context fields to provide accurate guidance based on the specific project configuration."
---
...
- [rules/bun.md](./rules/bun.md) — Bun's handling of node_modules, ESM, and package exports
