---
name: advanced-xml-prompting-for-code-agents
description: Comprehensive guide to advanced XML prompting strategies for delegating tasks to code agents, creating agent-driven workflows, and ensuring high assertiveness with large codebases
version: 1.0
author: Code Agent Architecture Team
last_updated: 2026-01-18
tags: [code-agents, prompt-engineering, XML-prompting, MCP-servers, delegation-patterns, large-codebases]
---

# Advanced XML Prompting for Code Agents: A Comprehensive SKILL Guide

## Table of Contents

1. [Introduction & Fundamentals](#introduction--fundamentals)
2. [XML Prompting Architecture](#xml-prompting-architecture)
3. [Simple Task Delegation](#simple-task-delegation)
4. [Advanced Task Delegation](#advanced-task-delegation)
5. [Creating Agent-Driven Workflows (AGENTS.md)](#creating-agent-driven-workflows)
6. [Context Management & Large Codebases](#context-management--large-codebases)
7. [Hallucination Prevention & Assertiveness](#hallucination-prevention--assertiveness)
8. [Sub-Agent Orchestration](#sub-agent-orchestration)
9. [Real-World Production Patterns](#real-world-production-patterns)
10. [Advanced Techniques & Optimization](#advanced-techniques--optimization)
...
**Claude Models** (especially Claude 4.5 and Opus): Exceptionally responsive to XML structures. Official Anthropic documentation explicitly recommends XML tags. Claude interprets each tag as a functional component, enabling precise alignment with your intent.

**GPT-4 Models**: Also responsive to XML but may require more explicit instructions. Combine XML with clear role definitions and format specifications.

**Gemini 2.5 Flash**: Excellent at layered prompts but requires clarity in hierarchy. Put meta-instructions before task details.
