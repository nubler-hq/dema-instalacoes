...
export const metadata: Metadata = pageMetadata({
  title: "Contato | Dema Instalações",
  description:
    "Fale com a Dema Instalações sobre instalações elétricas, hidráulicas, SPDA, entrada de energia, laudos e manutenção predial em São Paulo.",
  path: "/contato",
});
